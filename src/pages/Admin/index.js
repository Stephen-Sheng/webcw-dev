import { Col, Card, Row, Divider, Button, PageHeader, message } from "antd";
...
export default function Admin() {
    ...
    const handleReject = async (username) => {
        ...
        try {
            ...
            message.success("Pending Complete")
        } catch (error) {
            message.error(error)
        }
    }
        ...
        return (
            <Layout>
                <PageHeader
                    ...
                    title="Admin Pending System"
                    subTitle="Please judge these store applications!"
                />
                <List
                    grid={{
                        gutter: 16,
