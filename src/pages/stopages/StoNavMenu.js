    ...
    return (
        <Header className="header">
            ...
            <Menu theme="dark" mode="horizontal" defaultSelectedKeys={props.selected}>
                ...
                {user ? <><Menu.Item key="2"><Link href={'/Storelist'}>Current Orders</Link></Menu.Item>
                    <Menu.Item key="3"><Link href={'/orders'}>History Orders</Link></Menu.Item>
                </> :
                    <>
                    <Menu.Item key="2"><Link href={'/Storelist'} onClick={loginInfo}>Current Orders</Link></Menu.Item>
